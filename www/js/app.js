    ...
    .run(function ($sbhttp, $ionicConfig, $ionicHistory, $ionicPlatform, $ionicPopup, $ionicSlideBoxDelegate,
        ...
        $ionicPlatform.ready(function() {
            ...
            $ionicPlatform.registerBackButtonAction(function () {
				$log.debug((new Date()).getTime(), "Captured back button activity. Nothing to do");
			}, 100);
						...
						if(typeof chcp !== "undefined") {
							chcp.fetchUpdate(function (error, data) {
								if (error) {
									...
									$window.alert("NYOTA RIDE UPDATE\nThere is a new update to Nyota Ride. Within seconds your app will be updated to the latest version.");
									...
									chcp.installUpdate(function (error) {
										if (error) {
											$log.info("CHCP: Something went wrong with the update, will retry later.");
											$window.alert("NYOTA RIDE UPDATE: " + error.description);
										} else {
											$window.alert("NYOTA RIDE UPDATE\nYou are now running the latest version of Nyota Ride. Continue giving your feedback using 'Contact Us' option on the menu at the left part of your screen. Your feedback is valuable to us. Lets refresh your interface now..");
											return;
										}
									});
								}
